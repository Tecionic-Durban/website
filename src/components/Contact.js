...
export default function Contact() {
  ...
  return (
    <section ref={contactRef} id="contact-section" className="py-12 lg:py-24 bg-gradient-to-br from-gray-900 via-gray-800 to-emerald-900 text-white relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-8 relative">
        ...
        <div className="text-center mb-8 lg:mb-16 progressive-reveal">
          ...
          <p className="text-base lg:text-xl text-emerald-100 max-w-3xl mx-auto leading-relaxed">
            {t('description')}
          </p>
        </div>

        {/* Contact Pathways */}
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 lg:gap-6 mb-8 lg:mb-12 progressive-reveal">
          <a
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <span className="text-base lg:text-lg font-semibold text-emerald-200">{t('email')}</span>
            </div>
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <span className="text-base lg:text-lg font-semibold text-emerald-200">{t('contactForm')}</span>
            </div>
            <ChevronRight className="w-5 h-5 text-emerald-400 group-hover:translate-x-1 transition-transform duration-300" />
          </Link>
        </div>
        ...
        {/* Location Info */}
        <div className="text-center mb-8 lg:mb-12 progressive-reveal">
        ...
        <div className="text-center progressive-reveal">
          <p className="text-emerald-200/70 text-sm lg:text-lg">
            {t('trustLine')}
          </p>
        </div>
      </div>

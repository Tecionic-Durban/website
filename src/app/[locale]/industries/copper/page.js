      ...
      <div className="min-h-screen bg-white">
          ...
          <div className="max-w-[1400px] mx-auto px-4 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-16 items-start">
              ...
              <div ref={scrollContentRef} className="space-y-16">
                ...
                <div className="pt-16">
                  <div className="text-lg font-bold text-orange-900 uppercase tracking-wider mb-8">{t('stickyScroll.tecionic.label')}</div>

                  <div className="space-y-8 md:space-y-12">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-8 pb-8 md:pb-12 border-b border-orange-200">
                      <div>
                        <div className="text-2xl md:text-3xl font-bold text-gray-900">{t('stickyScroll.tecionic.items.capex.value')}</div>
                      </div>
                      <div className="md:col-span-2">
                        <div className="text-sm text-orange-700 uppercase tracking-wide mb-2">{t('stickyScroll.tecionic.items.capex.label')}</div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-8 pb-8 md:pb-12 border-b border-orange-200">
                      ...
                      <div className="md:col-span-2">
                        <div className="text-sm text-orange-700 uppercase tracking-wide mb-2">{t('stickyScroll.tecionic.items.mobilization.label')}</div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-8 pb-8 md:pb-12 border-b border-orange-200">
                      ...
                      <div className="md:col-span-2">
                        <div className="text-sm text-orange-700 uppercase tracking-wide mb-2">{t('stickyScroll.tecionic.items.maintenance.label')}</div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-8 pb-8 md:pb-12 border-b border-orange-200">
                      ...
                      <div className="md:col-span-2">
                        <div className="text-sm text-orange-700 uppercase tracking-wide mb-2">{t('stickyScroll.tecionic.items.technology.label')}</div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-8 pb-8 md:pb-12 border-b border-orange-200">
                      ...
                      <div className="md:col-span-2">
                        <div className="text-sm text-orange-700 uppercase tracking-wide mb-2">{t('stickyScroll.tecionic.items.scalability.label')}</div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-8">
                      ...
                      <div className="md:col-span-2">
                        <div className="text-sm text-orange-700 uppercase tracking-wide mb-2">{t('stickyScroll.tecionic.items.operation.label')}</div>
        ...
        <section className="py-20 bg-white border-t border-gray-100">
          <div className="max-w-[1400px] mx-auto px-4 lg:px-8">
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              <div>
                <div className="text-6xl font-bold text-orange-600 mb-4">{t('whyTecionic.steps.diagnosis.number')}</div>
              ...
              <div>
                <div className="text-6xl font-bold text-orange-600 mb-4">{t('whyTecionic.steps.setup.number')}</div>
              ...
              <div>
                <div className="text-6xl font-bold text-orange-600 mb-4">{t('whyTecionic.steps.operation.number')}</div>
        ...
        <section id="services" className="py-20 bg-gray-50">
          <div className="max-w-[1400px] mx-auto px-4 lg:px-8">
            ...
            <div className="bg-gradient-to-br from-orange-600 to-orange-700 rounded-2xl p-12 text-white">
              <div className="max-w-3xl">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <div className="text-orange-100 text-sm font-semibold mb-1">{t('services.backup.badge')}</div>
                ...
                <div className="space-y-4">
                  {['tif', 'tsf', 'entrainment', 'efficiency'].map((key) => (
                    <div key={key} className="flex items-center justify-between p-5 rounded-xl bg-emerald-50">
                      <span className="font-medium text-gray-700">{t(`caseStudy.metrics.${key}.label`)}</span>
                      <div className="text-right">
                        <div className="text-2xl font-bold text-orange-600">{t(`caseStudy.metrics.${key}.after`)}</div>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {['monthly', 'annual', 'avoided'].map((key) => (
                  <div key={key} className="text-center">
                    <div className="text-5xl font-bold text-orange-600 mb-2">{t(`caseStudy.economicImpact.${key}.value`)}</div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  {t.raw('mobileVsFixed.tecionic.items').map((item, i) => (
                    <div key={i} className="group relative flex items-start gap-4 p-6 rounded-2xl bg-gradient-to-br from-orange-50 to-orange-100 border border-orange-200 shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden">
                      {/* Subtle corner decoration */}
                      <div className="absolute top-0 right-0 w-24 h-24 bg-orange-200/30 rounded-bl-full"></div>

                      <div className="relative w-10 h-10 rounded-full bg-orange-500 flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform">
                        <CheckCircle className="w-5 h-5 text-white" />
                      </div>
                      <div className="relative">
                        <div className="font-bold text-orange-900 text-lg mb-1">{item.metric}</div>
                        <div className="text-sm text-orange-700">{item.label}</div>
                      </div>
                    </div>
                  ))}
                </div>

...
export async function generateMetadata({ params }) {
  ...
  const metadata = {
    'es-cl': {
      title: 'Contacto - Consulta Técnica Especializada | Tecionic',
    ...
    'pt-br': {
      title: 'Contato - Consulta Técnica Especializada | Tecionic',
    ...
    'en': {
      title: 'Contact - Specialized Technical Consultation | Tecionic',

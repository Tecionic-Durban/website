    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="border-b border-gray-200 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 lg:px-8 py-24 lg:py-32">
          ...
          <div className="flex md:grid md:grid-cols-2 gap-4 md:gap-6 max-w-4xl overflow-x-auto md:overflow-visible snap-x snap-mandatory -mx-4 px-4 md:mx-0 md:px-0 pb-4 md:pb-0" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none', WebkitOverflowScrolling: 'touch' }}>
            {/* Copper */}
        ...
        <div className="max-w-4xl mx-auto px-4 lg:px-8 py-20 text-center relative z-10">
          ...
          <div className="mt-12 pt-8 border-t border-white/15 max-w-3xl mx-auto">
            <div className="grid sm:grid-cols-3 gap-6">
              {Object.values(t.raw('cta.contact') || {}).map((office, i) => (
                <div key={i} className="text-left sm:text-center">
                  <div className="text-sm font-bold text-white mb-1">{office.label}</div>

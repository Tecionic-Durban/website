...
const metadataByLocale = {
  'es-cl': {
    title: 'Tratamiento de Borra SX y Recuperación de Orgánico | Reduce Pérdidas | Tecionic',
  ...
  'pt-br': {
    title: 'Tratamento de Borra SX e Recuperação de Orgânico | Reduz Perdas | Tecionic',
  ...
  'en': {
    title: 'SX Crud & Organic Recovery Service | Cut Organic Losses | Tecionic',

  ...
  const clientStories = [
    {
      ...
      background: "La refinería necesitaba modernizar sus procesos para mantenerse competitiva en un mercado global cada vez más desafiante.",
    ...
    },
    {
      ...
      background: "Como una de las minas de cobre más grandes del mundo, la operación buscaba optimizar continuamente sus procesos para mantener su liderazgo.",
    ...
    },
    {
      ...
      keyResults: [
        ...
        "Capacidad adicional significativa"
      ],
      background: "El productor de litio buscaba optimizar sus procesos para mantener su posición competitiva en un mercado en expansión.",
    ...
    {
      id: 4,
      client: "Productora de Zinc",
      clientLogo: null,
      industry: "Zinc",
      project: "Modernización de Electroobtención",
      testimonial: "El trabajo realizado por Tecionic en nuestra planta de electroobtención fue excepcional. Lograron modernizar completamente nuestras operaciones mientras manteníamos la producción. Los resultados incluyeron un 32% de mejora en eficiencia energética y una calidad de producto que superó nuestros estándares más exigentes.",
      spokesperson: "Gerente de Planta",
      position: "",
      ...
      background: "La planta necesitaba modernizar sus operaciones para cumplir con nuevos estándares de eficiencia y sostenibilidad.",
    ...
    {
      id: 5,
      client: "Minera de Cobre",
      clientLogo: null,
      industry: "Cobre",
      project: "Optimización Integral de Procesos",
      testimonial: "Tecionic nos ayudó a transformar nuestra operación. Su enfoque holístico y experiencia técnica profunda resultaron en mejoras que van más allá de lo que esperábamos. No solo optimizaron nuestros procesos técnicos, sino que también fortalecieron las capacidades de nuestro equipo humano.",
      spokesperson: "VP Operaciones",
      position: "",
      location: "Región de Antofagasta",
      duration: "15 meses",
      keyResults: [
      ...
      background: "La minera buscaba un socio estratégico para optimizar integralmente sus operaciones en múltiples sitios.",
      challenge: "Necesidad de estandarizar procesos y mejorar eficiencias en diferentes operaciones con características únicas.",

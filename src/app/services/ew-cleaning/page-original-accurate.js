        ...
        <div className="max-w-8xl mx-auto px-8">
          ...
          <div className="grid md:grid-cols-2 xl:grid-cols-5 gap-6">
            {processSteps.map((step, index) => (
              <div key={index} className="bg-slate-50 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 h-80 flex flex-col progressive-reveal">

    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section ref={heroRef} className="relative bg-white overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          {/* REALISTIC CIRCUIT BOARD TRACES - Organic routing like real PCB */}
          <div className="absolute inset-0 opacity-[0.06]" style={{
            backgroundImage: `url("data:image/svg+xml,%3Csvg width='1600' height='1200' viewBox='0 0 1600 1200' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' stroke='%23f59e0b'%3E%3C!-- Main circuit traces with organic routing --%3E%3Cg stroke-width='2' stroke-opacity='0.5'%3E%3Cpath d='M50 200 Q150 180 250 200 Q350 220 450 200 Q550 180 650 210 Q750 240 850 220 Q950 200 1050 230 Q1150 260 1250 240 Q1350 220 1450 250' /%3E%3Cpath d='M80 400 Q180 420 280 400 Q380 380 480 410 Q580 440 680 420 Q780 400 880 430 Q980 460 1080 440 Q1180 420 1280 450 Q1380 480 1480 460' /%3E%3Cpath d='M120 600 Q220 580 320 600 Q420 620 520 600 Q620 580 720 610 Q820 640 920 620 Q1020 600 1120 630 Q1220 660 1320 640 Q1420 620 1520 650' /%3E%3Cpath d='M90 800 Q190 820 290 800 Q390 780 490 810 Q590 840 690 820 Q790 800 890 830 Q990 860 1090 840 Q1190 820 1290 850 Q1390 880 1490 860' /%3E%3C/g%3E%3C!-- Vertical traces connecting horizontals --%3E%3Cg stroke-width='1.5' stroke-opacity='0.4'%3E%3Cpath d='M200 100 Q210 150 200 200 Q190 250 210 300 Q230 350 200 400 Q170 450 200 500 Q230 550 200 600 Q170 650 200 700 Q230 750 200 800 Q170 850 200 900' /%3E%3Cpath d='M400 120 Q390 170 400 220 Q410 270 390 320 Q370 370 400 420 Q430 470 400 520 Q370 570 400 620 Q430 670 400 720 Q370 770 400 820 Q430 870 400 920' /%3E%3Cpath d='M600 80 Q610 130 600 180 Q590 230 610 280 Q630 330 600 380 Q570 430 600 480 Q630 530 600 580 Q570 630 600 680 Q630 730 600 780 Q570 830 600 880' /%3E%3Cpath d='M800 140 Q790 190 800 240 Q810 290 790 340 Q770 390 800 440 Q830 490 800 540 Q770 590 800 640 Q830 690 800 740 Q770 790 800 840 Q830 890 800 940' /%3E%3Cpath d='M1000 110 Q1010 160 1000 210 Q990 260 1010 310 Q1030 360 1000 410 Q970 460 1000 510 Q1030 560 1000 610 Q970 660 1000 710 Q1030 760 1000 810 Q970 860 1000 910' /%3E%3Cpath d='M1200 90 Q1190 140 1200 190 Q1210 240 1190 290 Q1170 340 1200 390 Q1230 440 1200 490 Q1170 540 1200 590 Q1230 640 1200 690 Q1170 740 1200 790 Q1230 840 1200 890' /%3E%3C/g%3E%3C!-- Fine traces for detailed routing --%3E%3Cg stroke-width='1' stroke-opacity='0.3'%3E%3Cpath d='M150 150 Q200 160 250 150 Q300 140 350 160 Q400 180 450 160 Q500 140 550 170 Q600 200 650 170 Q700 140 750 180' /%3E%3Cpath d='M180 350 Q230 340 280 360 Q330 380 380 360 Q430 340 480 370 Q530 400 580 370 Q630 340 680 380 Q730 420 780 380' /%3E%3Cpath d='M160 550 Q210 540 260 560 Q310 580 360 560 Q410 540 460 570 Q510 600 560 570 Q610 540 660 580 Q710 620 760 580' /%3E%3Cpath d='M140 750 Q190 760 240 750 Q290 740 340 760 Q390 780 440 760 Q490 740 540 770 Q590 800 640 770 Q690 740 740 780' /%3E%3C/g%3E%3C!-- Micro traces for ultra fine detail --%3E%3Cg stroke-width='0.5' stroke-opacity='0.25'%3E%3Cpath d='M300 120 Q320 130 340 120 Q360 110 380 130 Q400 150 420 130 Q440 110 460 140 Q480 170 500 140' /%3E%3Cpath d='M320 320 Q340 310 360 320 Q380 330 400 320 Q420 310 440 330 Q460 350 480 330 Q500 310 520 340' /%3E%3Cpath d='M340 520 Q360 530 380 520 Q400 510 420 530 Q440 550 460 530 Q480 510 500 540 Q520 570 540 540' /%3E%3Cpath d='M360 720 Q380 710 400 720 Q420 730 440 720 Q460 710 480 730 Q500 750 520 730 Q540 710 560 740' /%3E%3C/g%3E%3C!-- IC chips with connection traces --%3E%3Cg fill='%23f59e0b' fill-opacity='0.1' stroke-width='1'%3E%3Crect x='250' y='180' width='100' height='60' rx='3' /%3E%3Crect x='550' y='280' width='120' height='80' rx='3' /%3E%3Crect x='850' y='380' width='90' height='70' rx='3' /%3E%3Crect x='450' y='580' width='110' height='90' rx='3' /%3E%3Crect x='750' y='680' width='130' height='100' rx='3' /%3E%3C/g%3E%3C!-- Connection pads and vias --%3E%3Cg fill='%23f59e0b' fill-opacity='0.6'%3E%3Ccircle cx='250' cy='210' r='3' /%3E%3Ccircle cx='350' cy='210' r='3' /%3E%3Ccircle cx='550' cy='320' r='3' /%3E%3Ccircle cx='670' cy='320' r='3' /%3E%3Ccircle cx='850' cy='415' r='3' /%3E%3Ccircle cx='940' cy='415' r='3' /%3E%3Ccircle cx='450' cy='625' r='3' /%3E%3Ccircle cx='560' cy='625' r='3' /%3E%3Ccircle cx='750' cy='730' r='3' /%3E%3Ccircle cx='880' cy='730' r='3' /%3E%3C/g%3E%3C!-- Via holes --%3E%3Cg fill='none' stroke='%23f59e0b' stroke-width='1' stroke-opacity='0.4'%3E%3Ccircle cx='300' cy='250' r='2' /%3E%3Ccircle cx='600' cy='350' r='2' /%3E%3Ccircle cx='900' cy='450' r='2' /%3E%3Ccircle cx='500' cy='650' r='2' /%3E%3Ccircle cx='800' cy='750' r='2' /%3E%3Ccircle cx='180' cy='180' r='2' /%3E%3Ccircle cx='480' cy='380' r='2' /%3E%3Ccircle cx='780' cy='580' r='2' /%3E%3Ccircle cx='1080' cy='280' r='2' /%3E%3Ccircle cx='1280' cy='480' r='2' /%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`,

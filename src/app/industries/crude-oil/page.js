...
export default function CrudeOilIndustryPage() {
  ...
  const FloatingElements = () => (
    <>
      <div className="fixed top-20 left-10 w-2 h-2 bg-gray-400/20 rounded-full animate-pulse"></div>
      <div className="fixed top-40 right-20 w-3 h-3 bg-gray-500/30 rounded-full animate-pulse [animation-delay:1s]"></div>
      <div className="fixed bottom-40 left-1/4 w-1 h-1 bg-gray-600/40 rounded-full animate-pulse [animation-delay:2s]"></div>
      <div className="fixed bottom-60 right-1/3 w-2 h-2 bg-gray-400/25 rounded-full animate-pulse [animation-delay:0.5s]"></div>
    </>
  )

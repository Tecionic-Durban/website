...
export const navigateToContactPage = (router) => {
  router.push('/contacto');
};

// For in-content quick contact CTAs - scroll to contact section
export const navigateToContactSection = (router, pathname) => {
  if (pathname === '/') {
...
export const handleContactClick = (e, router, pathname) => {
  e.preventDefault();
  navigateToContactPage(router);
};

// In-content contact button - scrolls to section
export const handleQuickContactClick = (e, router, pathname) => {
  e.preventDefault();
  navigateToContactSection(router, pathname);
};
